...
internal fun Filters.toBluetoothLEScanOptions(): BluetoothLEScanOptions = jso {
    if (isEmpty()) {
...
internal fun Filters.toBluetoothLEScanFilterInit(): List<BluetoothLEScanFilterInit> =
